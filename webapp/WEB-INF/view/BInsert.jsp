     ...
     <div class="container">
         ...
         <p>
            <div class="col-md-8 col-md-offset-2">
				  <form action="B_insert.do" class="row">
		    		<div class="form-group" >
				      <label for="id">= 제목 =</label>
				      <input type="text" class="form-control" placeholder="Enter MAX Title 20" name="btitle" maxlength='20' style="border-radius: 30px; width: 350px; height: 50px; margin:auto;" required>
				    </div> 
				       
				    <div class="form-group">
				      <label for="pwd">= 내용  =</label>
				      <textarea class="form-control" placeholder="Enter MAX 400" name="borad" maxlength='400' style="resize: none; border-radius: 30px; width: 350px; height: 350px; margin:auto;" required></textarea>
				    </div>
